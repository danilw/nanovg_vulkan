...
// stb_image.h initialization because it already included by nanovg
...
// -----end of nanovg Vulkan related functions
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("files_example_vulkan_glfw_integration/shaders/vert.spv");
        auto fragShaderCode = readFile("files_example_vulkan_glfw_integration/shaders/frag.spv");
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("images/image12.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
